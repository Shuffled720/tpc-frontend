...
import { internshipData } from "./cardComponent";
...
export default function FilterButton() {
  ...
  return (
    <div className=" my-auto rounded-md">
      <div className=" my-auto rounded-md flex flex-row justify-end w-1/12 absolute right-0 top-2">
        <button
          onClick={openModal}
          className="bg-blue-500 hover:bg-blue-700 text-white font-bold h-8 px-4 my-2 ml-0 rounded-md absolute left-0 top-12"
        >
          Filters
        </button>
      </div>
